...
function MediaPost({ post }) {
    ...
    const [loadingSharingPost, setLoadingSharingPost] = useState(false);
    ...
    return (
        <div>
            ...
            {post.media_type &&
                post.media_type.startsWith("application/pdf") && (
                    <div className="al-photos w-full overflow-auto flex flex-row p-2">
                        <>
                            <a
                                ...
                                download={true}
                                target="_blank"
                                className="mt-2 w-full rounded-lg shadow-lg cursor-pointer border py-2 px-3 bg-slate-800"
                            >
            ...
            <IFCondition condition={post.sharing_post_id}>
                <IFCondition condition={loadingSharingPost}>
                    <center className="p-2">
                        <Loading />
                    </center>
                </IFCondition>
                <IFCondition
                    condition={!loadingSharingPost && sharingPost != null}
                >
                    <Post {...sharingPost} borderFull />
                </IFCondition>
            </IFCondition>
