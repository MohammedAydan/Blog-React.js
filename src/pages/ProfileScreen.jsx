          ...
          <div className="flex flex-col sm:flex-row items-center justify-center space-x-4 max-w-2xl mx-auto">
            ...
            <div className="mt-3 sm:mt-0">
              <div className="text-lg text-gray-300 dark:text-gray-300">
                ...
                >
                  Friends: {resFriends == null ? "" : resFriends.length}
                </p>
              </div>
            ...
            >
              ...
              {!loadingReq &&
                ...
                Object.values(resFriends).map((f) => {
                  let userData = f.owner_id == user.id ? f.user : f.owner;

                  return (
                    <Link key={f.id} to={`/profile/${userData.id}`}>
                      <div className="flex items-center p-2">
                        <UserAvater imgUrl={f.user?.img_url} user={f.user} />
                        <p>{userData.name}</p>
                      </div>
                    </Link>
                  );
